    ...
    <div class="container">
        ...
        <div class="terminal" id="section1">
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="media">
                        <img src="pipcrop.jpg" class="align-self-start mr-3" alt="...">
                        <div class="media-body">
                            <h4 class="det">Details about me</h4>
                            <p class="det output">Name: Umesh chandra bhuyan</p>
                            <p class="det output">Email: imumesh@techie.com</p>
                            <p class="det output">linkedin: <a href="https://www.linkedin.com/in/umesh-chandra-bhuyan-8000a3bb/">link</a>
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="skills">
                        <h4 class="det">professional skills</h4><br>
                        <div id="webProgress">
                            <div id="webBar">
            ...
            <div class="col-sm-12"><br>
                <a class="arrow" href="#section2">
                    <img src="down.png" alt="" height="50px;" width="50px;">
                </a>
            </div>
        </div>
        <br> <br> <br>
        ...
        <div class="col-xd-12 det" id="section2">
            ...
            <div class="w3-row-padding">
                    ...
                    <div class="w3-third">
                      ...
                      <div class="w3-third">
                        <h2 style="margin-left: 1.5rem;">c</h2>
                        <div class="w3-third">
